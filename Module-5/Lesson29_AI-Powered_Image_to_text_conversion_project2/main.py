...
# Helper: Truncate text to specific word count.
...
def print_menu():
    ...
    print(f"{Fore.GREEN}Image-to-Text Conversion")
...
def main():
    ...
    print(f"{Fore.YELLOW}🤔 Basic caption: {Style.BRIGHT}{basic_caption}{Style.RESET_ALL}")
    while True:
        print_menu()
        ...
        if choice == "1":
            ...
            print(f"{Fore.GREEN}✅ Caption (5 words): {Style.BRIGHT}{caption}{Style.RESET_ALL}")
        elif choice == "2":
            ...
            try:
                ...
                print(f"{Fore.GREEN}✅ Description (30 words): {Style.BRIGHT}{description}{Style.RESET_ALL}")
            except Exception as e:
            ...
            try:
                ...
                print(f"{Fore.GREEN}✅ Summary (50 words): {Style.BRIGHT}{summary}{Style.RESET_ALL}")
            except Exception as e:
